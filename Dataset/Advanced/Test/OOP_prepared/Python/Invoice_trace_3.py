...
if __name__ == "__main__":
    c3 = Customer(3, "Carol White", 25)
    inv3 = Invoice(103, c3, 1500)
    inv3.get_customer().set_discount(30)
    print(inv3.get_customer_discount())
    print(inv3.get_amount_after_discount())
    print(inv3)