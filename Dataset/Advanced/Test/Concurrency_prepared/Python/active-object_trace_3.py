...
if __name__ == "__main__":
    ...
    integrator1 = Integrator(lambda t: log(t+1), steps=5)
    integrator2 = Integrator(lambda t: sin(pi * t), steps=5)
    integrator3 = Integrator(lambda t: cos(pi * t), steps=5)

    # Wait for both integrators to complete
    integrator1.join()
    integrator2.join()
    integrator3.join()#END
