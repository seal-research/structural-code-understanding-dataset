...
if __name__ == "__main__":
    ...
    integrator1 = Integrator(lambda t: cos(pi * t), steps=3)
    integrator2 = Integrator(lambda t: sin(pi * t), steps=3)
    integrator3 = Integrator(lambda t: sqrt(pi * t), steps=3)
    integrator4 = Integrator(lambda t: log(pi * t + 0.1), steps=3)

    # Wait for both integrators to complete
    integrator1.join()
    integrator2.join()
    integrator3.join()
    integrator4.join()#END
    ...
    print("Integrator 4 result:", integrator4.S)
