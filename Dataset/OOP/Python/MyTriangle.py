...
class TestMyTriangle:
    @staticmethod
    def main():
        my_triangle = MyTriangle(MyPoint(5, 5), MyPoint(15, 15), MyPoint(5, 25))
        print(my_triangle.get_perimeter())
        print(my_triangle.get_type())
        print(my_triangle.get_v1())
        print(my_triangle.get_v2())
        print(my_triangle.get_v3())
        print(my_triangle)
